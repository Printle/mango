defmodule Mango.Web.ClientController do
  ...
  def new(conn, _params) do
    changeset = Clients.change_client(%Mango.Clients.Client{})
  ...
  def show(conn, %{"id" => id}) do
    ...
    todos = Clients.get_todos_for client
    render(conn, "show.html", client: client, todos: todos)
  end
